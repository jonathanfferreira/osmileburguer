...
const marqueeText='BURGER <span>✳</span> SMILE <span>✳</span> FRIES <span>✳</span> DELIVERY <span>✳</span> ';
...
<nav id="mobile-nav" class="mobile-nav" aria-label="Navegação mobile" hidden><a href="#favoritos"><span>01</span> FAVORITOS ↗</a><a href="#por-dentro"><span>02</span> POR DENTRO ↗</a><a href="#combos"><span>03</span> COMBOS ↗</a></nav>
<main>
<section class="hero" id="inicio" aria-labelledby="hero-title">
  <div class="hero-copy">
    <p class="eyebrow"><span class="mini-star" aria-hidden="true">✳</span> JOINVILLE • SC <span class="eyebrow-separator">/</span> FEITO PRA SORRIR</p>
    ...
    <div class="hero-actions">${order('PEDIR AGORA','hero')}<a class="text-link" href="#favoritos">VER OS FAVORITOS <span aria-hidden="true">↓</span></a></div>
  ...
  <div class="hero-art" data-depth="hero">
    ...
    <span class="hero-sticker"><small>ARTESANAL</small><b>ATÉ O<br>ÚLTIMO<br>SORRISO.</b><small>★ JOINVILLE ★</small></span>
    <span class="hero-note">fome de respeito.<br>sorriso garantido.<span aria-hidden="true">⤴</span></span>
    <span class="hero-spark" aria-hidden="true">✦</span>
  </div>
  <div class="hero-bottom"><span>BURGER BOM. HUMOR MELHOR AINDA.</span><a href="#favoritos">DESCE QUE TEM MAIS <span aria-hidden="true">↓</span></a></div>
</section>
...
<section class="favorites section" id="favoritos" aria-labelledby="favorites-title">
  ...
  ${products.slice(0,3).map((p,i)=>`<article class="product-poster poster-${i} reveal" data-depth="poster" data-product="${p.id}">
    <div class="poster-top"><span>0${i+1} / FAVORITOS</span><span aria-hidden="true">✳</span></div>
    <h3>${p.name}</h3>
  ...
  </div><p class="swipe-note">DESLIZE PRA DAR MATCH COM A SUA FOME <span aria-hidden="true">⟷</span></p>
</section>
...
<div class="fries-note"><span aria-hidden="true">✳</span><p><b>NÃO ESQUECE A BATATA!</b> Uma porção de 150g pra completar o sorriso.</p><a class="text-link" href="${ORDER_URL}" target="_blank" rel="noopener noreferrer" data-order="combo">EU QUERO ↗</a></div>
</section>
...
<footer><div class="footer-top">${logo(true)}<div><b>FEITO EM JOINVILLE.</b><span>Joinville – SC</span></div><div><b>HORA DO SMILE</b><span>Segunda a sexta<br>19h – 23h</span></div><div><a href="${siteSettings.socialLinks.instagram}" target="_blank" rel="noopener noreferrer" data-instagram>INSTAGRAM ↗</a><a href="${ORDER_URL}" data-order="footer" target="_blank" rel="noopener noreferrer">CARDÁPIO / PEDIDOS ↗</a></div></div><div class="footer-bottom"><span>© ${new Date().getFullYear()} O Smile Burger</span><b>KEEP SMILING :)</b><a href="#inicio">LÁ PRA CIMA ↑</a></div></footer>
