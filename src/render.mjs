...
<nav id="mobile-nav" class="mobile-nav" aria-label="Navegação mobile" hidden><a href="#favoritos"><span>01</span> FAVORITOS ↗</a><a href="#por-dentro"><span>02</span> POR DENTRO ↗</a><a href="#combos"><span>03</span> COMBOS ↗</a><div class="mobile-nav-footer">${order('PEDIR AGORA','header','mobile-menu-order')}</div></nav>
<main>
